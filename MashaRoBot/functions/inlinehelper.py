...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("Get More Help.", url=f"t.me/guardiantgbot?start=start"),
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Bot", url="https://t.me/Guardiantgbot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[GUARDIAN](https://t.me/TEAMGUARDIANSCHAT):**
**BOT CONDITION:** `{bot_state}`
**DATABASE:** 𝘙𝘶𝘯𝘯𝘪𝘯𝘨 𝘯𝘰𝘳𝘮𝘢𝘭𝘭𝘺
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
**MongoDB:** `{mongover}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/7d66554632c8750448404.jpg",
