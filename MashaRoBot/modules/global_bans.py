...
def gban(update: Update, context: CallbackContext):
    ...
    if int(user_id) == OWNER_ID:
        message.reply_text(
             "🙄🙄 Who is that fucker trying to gban my <a href="http://t.me/THE_BOSS_OF_TELEGRAM">Owner </a><br /></p> 🥱? You just burn in hell🤭🤭."
        )
        return

    if int(user_id) in DEV_USERS:
        message.reply_text(
            "He fucker 🥱 , He is my dev . How can you gban him😑"
        )
        return
    ...
    message.reply_text("On the Switch😉")
    ...
    if gban_time > 60:
        ...
        message.reply_text("Done! Gbanned. View logs [here](t.me//kittygbanlogs) .", parse_mode=ParseMode.HTML)
