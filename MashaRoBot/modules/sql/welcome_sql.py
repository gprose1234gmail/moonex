...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Welcome {first}, Who is your Xlover🥺?",
    "உங்கள் முதல் ஆசிரியர் யார்🤔?",
...
DEFAULT_GOODBYE_MESSAGES = [
    "{first} moodetu po da🥱.",
    "{first} Kelambu kelambu anthu pochi kelambu kelambu🤣.",
    "{first} Enna ithukku left aahura😡.",
    "{first} Hey you fucker😒 . For lefting y you join here🙄.",
    "{first} Enna pa inga vandhavanga ella thunda kaalu thuniya kaalu nu ooduranga🤣.",
    "{first} .",
